...
const Form = () => {
  ...
  const [userData,setUserData]=useState({
    ...
    const submitHandler = async(event)=>{
      ...
      const { category,name,email,contact,pid,pt,country,state,district,location}=userData;
    try{
     if(category && name && email && contact && pid && pt && country && state && district && location){
