  ...
  const handleChange=(e)=>{
    ...
    const submitHandler = async(event)=>{
      ...
      const {
        ...
        createdDate,
        modifiedDate,
        parts: [{ supplier_category, supplier_name, material, mpn_number, weight, dimensions, cost, lead_time, quality_matrices, compliance_information }],
      } = userData;
    try{
        ...
        <div className={classes.container}>
            <form className={classes.form} onSubmit={submitHandler}>
              ...
              <div className={classes.input}>
                ...
                <input type='number'  name="part_number"  value={userData.part_number} onChange={postUser} />
              </div>
             ...
             return(<>
              ...
              <div className={classes.input}>
                ...
                <input type='number' name="mpn_number" value={part.mpn_number} onChange={(event) => postUserData(event, index)}/>
              </div>
