            ...
            <form className={classes.form} onSubmit={submitHandler}>
             ...
             <h4>Autogenerated Id(M00001)</h4>
              ...
              <div className={classes.input}>
                  ...
                  <div className={classes.input}>
                    <label htmlFor='text'>Upload Contract Document*</label>
                    <input type='file' id='document' name="document"  value={userData.document} onChange={postUserData}/>
                  </div>
