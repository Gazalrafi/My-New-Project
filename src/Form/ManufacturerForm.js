...
const ManufacturerForm = () => {
  ...
  const [userData,setUserData]=useState({
    ...
    const postUserData=(event)=>{
      ...
      // If the event target is the file input, handle the file name or perform additional actions
      if (event.target.type === 'file') {
         const fileName = event.target.files[0].name;
         // Perform actions related to the file, e.g., display the file name
    ...
    try{
     if(name && email && contact && pid && pt && country && state && district && location && start_date && end_date){
           ...
           <h4>Autogenerated Id(V00001)</h4>
            ...
            <div className={classes.input}>
                ...
                <div className={classes.input}>
                  ...
                  <input type='file' id='document' name="document" onChange={postUserData}/>
                </div>
